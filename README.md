...
- 共 9,388 道内置唯一题目，题库启动时自动校验并同步到 SQLite

## 最近更新 · 2026-09-23 · v0.2.6

- 发布考匠移动端 v0.2.6：同步网络工程师一级、二级、三级知识点目录；每一级均可直接练习或展开下一级。
- 修复章节练习展开三级考点时因分类数据形态不一致导致的白屏。
- 网站登录页、账号菜单和版本公告已切换至 [`kaojiang-v0.2.6.apk`](public/downloads/kaojiang-v0.2.6.apk)；版本接口默认将最新版和最低支持版本更新为 v0.2.6。
...
- 网站登录页、账号菜单和版本公告已切换至 [`kaojiang-v0.2.5.apk`](public/downloads/kaojiang-v0.2.5.apk)；版本接口最低支持版本更新为 v0.2.5，并保留应用内和浏览器下载方式。
...
- 网站登录页和账号菜单已切换到 [`kaojiang-v0.2.3.apk`](public/downloads/kaojiang-v0.2.3.apk)；版本接口默认将最新版和最低支持版本更新为 v0.2.3。

## 历史更新 · 2026-09-22 · v0.2.2

- 发布考匠移动端 v0.2.2：版本过旧时可直接在 App 内下载 APK 并调起 Android 系统安装器，同时保留浏览器下载备用入口；系统仍会要求用户确认安装。
- 网站登录页和账号菜单已切换到 [`kaojiang-v0.2.2.apk`](public/downloads/kaojiang-v0.2.2.apk)；版本接口默认将最新版和最低支持版本更新为 v0.2.2。

## 历史更新 · 2026-09-22 · v0.2.1

- 发布考匠移动端 v0.2.1：新增启动版本校验和服务端兜底。低于服务器最低版本的旧 App 会锁定功能，只能下载最新版 APK 后继续使用；旧客户端调用移动端 API 也会收到更新提示和下载地址。
- 网站登录页和账号菜单已切换到 [`kaojiang-v0.2.1.apk`](public/downloads/kaojiang-v0.2.1.apk) 下载链接；版本接口会返回当前最新版、最低支持版本、更新说明和下载地址。
...
- 登录页和网站账号菜单都提供“下载 App”，旧 APK 已下线，当前统一下载 [`kaojiang-v0.2.1.apk`](public/downloads/kaojiang-v0.2.1.apk)。
...
Android v0.2.4 已接入现有网站 API，支持登录、证书选择、今日学习概览、知识点练习、完整题库加载、收藏题目、错题复习、顺序刷题、随机刷题、题目举报、AI 学习服务和考匠社区。今日学习会从当前题库随机抽取 30 道题，独立于普通练习的顺序/随机模式。启动时会校验版本，旧版本必须通过 [`public/downloads/kaojiang-v0.2.4.apk`](public/downloads/kaojiang-v0.2.4.apk) 更新后才能继续使用；v0.2.2 及以后版本支持应用内下载更新，并保留浏览器下载备用方式。
