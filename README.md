...
## 最近更新 · 2026-09-26 · v0.3.1

- App 新增交互提示音，提供轻柔、清脆、醇厚三种音色；“我的 → 外观、动画与音效”支持开关、四档音量和试听，设置自动保存。
- 底部社区入口调整为 VIP 套餐展示；社区和排行榜整合到“我的”。会员支付及实时额度仍待接入，页面明确显示尚未开通。
- 修复已共享 AI 题组未计入提交题目排行榜的问题。
- Android 版本升至 v0.3.1（versionCode 15），最低支持版本保持 v0.2.8。
- 安装包：[kaojiang-v0.3.1.apk](public/downloads/kaojiang-v0.3.1.apk)。

## 历史更新 · 2026-09-26 · v0.3.0
...
- v0.3.0 安装包已从当前仓库清理，源码和旧安装包仍可从 Git 历史恢复。
