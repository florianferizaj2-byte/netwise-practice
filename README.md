...
Android v0.2.1 已接入现有网站 API，支持登录、证书选择、今日学习概览、题库练习、错题复习、顺序刷题、随机刷题、题目举报、AI 学习服务和考匠社区。启动时会校验版本，旧版本必须通过 [`public/downloads/kaojiang-v0.2.1.apk`](public/downloads/kaojiang-v0.2.1.apk) 更新后才能继续使用。
