...
## 最近更新 · 2026-09-22 · v0.2.4

- 发布考匠移动端 v0.2.4：练习区先选择章节和知识点，每个知识点显示“已刷题数 / 题库总题数”进度条；进入后加载该知识点的完整题库，随机刷题不再限制为 10 道。
- 新增收藏题目入口和题目星标，收藏状态按账号保存；错题复习中答对后可以手动移除错题。
- Web 端同步题库进度、收藏入口、收藏按钮和错题移除操作；网站登录页、账号菜单和版本公告已切换到 [`kaojiang-v0.2.4.apk`](public/downloads/kaojiang-v0.2.4.apk)。
- 版本接口默认将最新版和最低支持版本更新为 v0.2.4，旧移动端会进入更新页；应用内下载和浏览器下载两种方式继续保留。
